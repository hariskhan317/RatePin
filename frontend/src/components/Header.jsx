        ...
        <div className='flex gap-3'>
          ...
          {currentUser ? (
            ...
            <button onClick={() => {
              setShowSignin(false)
              setShowLogin(true)
                }} className='w-auto h-auto px-10 py-2 rounded-lg bg-orange-600 font-montserrat text-white font-semibold'>Log In</button>     
            <button onClick={() => {setShowLogin(false)
              setShowSignin(true)}} className='w-auto h-auto px-10 py-2 rounded-lg bg-indigo-600 font-montserrat text-white font-semibold'>Sign In</button>       
            </div>
          )}
